...
public class BoardController extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (command.equals("/BoardListAction.do")) {//등록된 글 목록 페이지 출력하기
			...
			rd.forward(request, response);
				...
				RequestDispatcher rd = request.getRequestDispatcher("/BoardListAction.do");
				rd.forward(request, response);				
		} else if (command.equals("/AddResponseAction.do")) { //선택된 글 답변 추가하기
				requestResponseWrite(request);
				RequestDispatcher rd = request.getRequestDispatcher("/BoardView.do");
				rd.forward(request, response);				
		} 
	}
   ...
   //새로운 글 등록하기
	...
	//선택된 글 답변 추가하기
	public void requestResponseWrite(HttpServletRequest request){
	    ...
	    System.out.println("Board Number: " + num);
	    System.out.println("Response: " + responseText);	    

	    dao.addResponse(num, responseText);							
	}
